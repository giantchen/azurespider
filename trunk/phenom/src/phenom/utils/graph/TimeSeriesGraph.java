...
public class TimeSeriesGraph extends ApplicationFrame {
	...
	public TimeSeriesGraph(final String title, final String XAxisName,
	...
	private JFreeChart createChart(XYDataset dataset) {
		JFreeChart chart = ChartFactory.createTimeSeriesChart(title, XAxisName,
				YAxisName, dataset, true, true, false);
