...
public class ExtendedDataInputStream extends DataInputStream {
	...
	/*
	 * Default java data is high bit first low bit last the Qianlong is high bit
	 * last low bit first
	 */
	...
	/*
	 * struct Weight { unsigned long date; // 日期高12bit为年，接着4bit为月，接着5bit为日
	 * unsigned long gift_stock; // 送股数* 10000 unsigned long stock_amount; //
	 * 配股数* 10000 unsigned long stock_price; // 配股价* 1000 unsigned long bonus;
	 * // 红利* 1000 unsigned long trans_num; // 转增数 unsigned long total_amount;
	 * // 总股本，单位万 unsigned long liquid_amoun; // 流通股，单位万
	 */
